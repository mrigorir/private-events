class Event < ApplicationRecord
  ...
  validates :event_name, presence: true, length: { minimum: 5, maximum: 50, message: 'Write between 5 and 50 characters.' }
  validates :event_location, presence: true, length: { minimum: 2, maximum: 100, message: 'Write between 2 and 100 characters.' }
